...
public class Time {
    ...
    public static String toString(long time) {
        ...
        time = appendTime(time, YEAR_MS, "year", timeString);
        time = appendTime(time, DAY_MS, "day", timeString);
        time = appendTime(time, HOUR_MS, "hora", timeString);
        time = appendTime(time, MINUTE_MS, "minute", timeString);
        time = appendTime(time, SECOND_MS, "second", timeString);
