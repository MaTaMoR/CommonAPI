...
public class NMSClassLoader<T> {
    ...
    public boolean load() {
        ...
        try {
            this.plugin.getLogger().info("Trying to loadOrCreate NMSClass from: " + classPath);
            ...
            this.plugin.getLogger().log(Level.SEVERE, "The plugin couldn't create the NMS controller instance and has been disabled. This is likely" +
                    "due to no supported Hologram implementation for your CraftBukkit/Spigot version.", ex);
            return false;
        }
