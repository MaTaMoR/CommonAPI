...
public class SimpleCustomInventory implements CustomInventory {
    ...
    public Inventory createInventory(Player player) {
        ...
        Inventory inventory = Bukkit.createInventory(new CustomInventoryHolder(this), this.size.getSize(), InventoryUtils.fullFormat(this.title, player));
        ...
        for (Map.Entry<Integer, InventoryIcon> entry : this.icons.entrySet()) {
            ...
            try {
                ...
                CommonAPI.getInstance().getLogger().log(Level.SEVERE, "Error while building item in slot: " + entry.getKey(), e);
            }
        }
    ...
    public void update(Player player) {
        ...
        if (inventory.getHolder() instanceof CustomInventoryHolder) {
            ...
            if (getSize().getSize() != inventory.getSize() || !Objects.equals(inventory.getTitle(), InventoryUtils.fullFormat(this.title, player))) {
