...
public class PingResponse {
    ...
    public PingResponse(String jsonString, ServerAddress address) {
        if (jsonString == null || jsonString.isEmpty()) {
            ...
            CommonAPI.getInstance().getLogger().severe("Received empty Json response from IP \"" + address.toString() + "\"!");
            return;
        }
        ...
        if (!(jsonObject instanceof JSONObject)) {
            motd = "Invalid ping response";
            CommonAPI.getInstance().getLogger().severe("Received invalid Json response from IP \"" + address.toString() + "\": " + jsonString);
            return;
        }
