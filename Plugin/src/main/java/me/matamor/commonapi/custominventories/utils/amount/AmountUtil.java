package me.matamor.commonapi.custominventories.utils.amount;
            ...
            if (serialized.contains(",")) {
                ...
                if (split.length > 1) {
                    ...
                    for (String value : split) {
                        values.add(CastUtils.asInt(value));
                    }

                    return new RandomAmount(values);
                } else {
                    throw new CastUtils.FormatException("The serialized amount (" + serialized + ") must have more than one value to be RandomAmount");
                }
                ...
                if (split.length == 2) {
                    ...
                    throw new CastUtils.FormatException("The serialized amount (" + serialized + ") must have two values to be RangeAmount");
                }
            } else {
