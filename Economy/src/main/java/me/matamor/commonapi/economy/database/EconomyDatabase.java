...
import me.matamor.commonapi.storage.database.defaults.multi.PlayerSimpleMultiDatabaseManager;
...
public class EconomyDatabase extends PlayerSimpleMultiDatabaseManager<EconomyEntry> {

    public EconomyDatabase(EconomyModule plugin) {
