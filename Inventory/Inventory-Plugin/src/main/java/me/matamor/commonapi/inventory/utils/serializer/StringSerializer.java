package me.matamor.commonapi.inventory.utils.serializer;
...
import me.matamor.commonapi.inventory.item.SimpleCustomItem;
import me.matamor.commonapi.inventory.utils.MaterialEntry;
import me.matamor.commonapi.utils.CastUtils;
import me.matamor.commonapi.utils.enchantment.MinecraftEnchantments;
...
public class StringSerializer {
    ...
    public static MaterialEntry getMaterial(String text) throws StringSerializerException {
        ...
        if (matcher.find()) {
            ...
            return new MaterialEntry(material, dataValue, amount);
        }
    ...
    public static CustomItem getItem(String text) throws StringSerializerException {
        ...
        return SimpleCustomItem.builder(material.getMaterial(), material.getAmount(), material.getDataValue()).setName(name).setLore(lore)
    ...
    public static String toString(CustomItem customItem) {
        ...
        stringBuilder.append("material:").append(customItem.getMaterial().name()).append(":").append(AmountUtil.serialize(customItem.getAmount())).append(":").append(customItem.getDataValue());
